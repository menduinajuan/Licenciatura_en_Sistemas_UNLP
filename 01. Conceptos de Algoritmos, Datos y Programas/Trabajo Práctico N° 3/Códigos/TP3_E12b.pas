...
begin
  ...
  begin
    calcular_ab(registro_alumno.condicion,registro_alumno.presente,ingresantes_total,ingresantes_parcial,recursantes_total,recursantes_parcial);
    ...
    calcular_f(registro_alumno.notas_diez,registro_alumno.legajo,notas_diez_max1,notas_diez_max2,legajo_diez_max1,legajo_diez_max2);
    calcular_g(registro_alumno.notas_cero,registro_alumno.legajo,notas_cero_max1,notas_cero_max2,legajo_cero_max1,legajo_cero_max2);
    leer_alumno(registro_alumno);
  end;
end;
var
