...
var
  ...
  i, j, nota, presente, nota_total, notas_cero, notas_diez, notas_diez_max1, notas_diez_max2, notas_cero_max1, notas_cero_max2: int8;
  legajo, ingresantes_parcial, ingresantes_total, recursantes_parcial, recursantes_total, alumnos_autoeva, alumnos_corte, alumnos_cero, legajo_diez_max1, legajo_diez_max2, legajo_cero_max1, legajo_cero_max2: int16;
  condicion: char;
begin
  randomize;
