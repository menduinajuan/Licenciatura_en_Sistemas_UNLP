...
begin
  ...
  begin
    ...
    textcolor(green); write('Se ha eliminado el empleado con número '); textcolor(yellow); write(numero); textcolor(green); writeln(' en el archivo');
  end
  else
  begin
    textcolor(green); write('No se ha encontrado el empleado con número '); textcolor(yellow); write(numero); textcolor(green); writeln(' en el archivo');
...
begin
  ...
  textcolor(yellow); write('OPCIÓN 9: '); textcolor(green); writeln('Eliminar un empleado del archivo, copiando el último registro en la posición del registro a borrar y truncando el archivo');
