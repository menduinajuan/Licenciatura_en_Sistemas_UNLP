...
public class DateLapseTest {
    ...
    @Test
    public void testIsWithinXDaysBeforeStart() {
        DateLapse dateLapse2=new DateLapse(this.from.plusDays(365), this.to.plusDays(365));
        assertFalse(this.dateLapse.isWithinXDaysBeforeStart(0));
        assertTrue(dateLapse2.isWithinXDaysBeforeStart(25));
        assertTrue(dateLapse2.isWithinXDaysBeforeStart(24));
        assertFalse(dateLapse2.isWithinXDaysBeforeStart(23));
    }
